...
<div class="sport" onclick="location.href='?clubseq=1'">
...
<div class="sport" onclick="location.href='?clubseq=7'">
...
<div class="sport" onclick="location.href='?clubseq=8'">
