      	    ...
      	    return function() {
      	    	...
      	    	$.ajax({
		    		...
		    		success:function(json){
		    			...
		    			v_html += "<div class='section'>";
		    			v_html += "<img src='<%=ctxPath%>/resources/images/uploadImg/"+json.filename+"' class='gym-image' alt='체육관 사진'>";
		    			v_html += "</div>";
	...
	<div style="display: flex">
	    ...
	    <div class="container">
	    	<div class="container1">
		        <!-- 체육관 사진 -->
		        <div class="section">
		            <img src="<%=ctxPath%>/resources/images/uploadImg/${requestScope.gymvo.filename}" class="gym-image" alt="체육관 사진">
		        </div>
